...
class StepThree {
    ...
    setSourcePath(source = '') {
        if (!source) {
            return this._sourcePath = "./downloads/sortedlist.txt";
        }
        else {
    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < counter; i++) {
                const resolve = yield this._results.thirdCall(arrayList[i], timer);
            ...
            try {
                const processList = new ProcessList_1.ProcessList("./links", this.getStorePath);
                yield processList.process();
                console.log(chalk_1.default.blue("Detail list created........."));
            }
            catch (error) {
                console.log(error);
                process.exit(0);
